    ...
    <section className={`xlg:hidden px-[72px] pt-[20px] max-xmd:p-[20px] h-[100px]  ${navClassName}  bg-gradient z-[150] `}>
            ...
            <div className={`${navBarDisplay} flex-col justify-center items-center`}>
               <ul className="nav-bar flex flex-col gap-6 text-[#1D1C1C] font-semibold text-lg justify-center items-center">
                  <li><a href="#" onClick={()=> {setActiveNav('#'); toggleMenu()}} className= {activeNav === '#'? 'nav-active': 'nav-links'}>Home</a></li>
                  <li><a href="#features" onClick={()=>{setActiveNav('#features'); toggleMenu()}} className= {activeNav === '#features'? 'nav-active': 'nav-links'}>Features</a></li>
                  <li><a href="#about-us" onClick={()=>{setActiveNav('#about-us'); toggleMenu()}} className= {activeNav === '#about-us'? 'nav-active': 'nav-links'}>About Us</a></li>
                  <li><a href="#how-it-works" onClick={()=>{setActiveNav('#how-it-works'); toggleMenu()}} className= {activeNav === '#how-it-works'? 'nav-active': 'nav-links'}>How it works</a></li>
                  <li><a href="#contact-us" onClick={()=> {setActiveNav('#contact-us'); toggleMenu()}} className= {activeNav === '#contact-us'? 'nav-active': 'nav-links'}>Contact Us</a></li>        
             </ul>
