  ...
  return (
        <section className='flex flex-col gap-[35px]'>
            <section className='flex relative'>
               <div className='bg-white py-[48px] px-6 flex gap-[40px] rounded-[20px] shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(0,69,165,0.2)] w-[50%]'>
                       <div className=' '>
                  ...
                  <div className='absolute top-[100px] left-[50%] '>
                    <img src="processline1.svg" alt="" />
                  </div>
            </section>
            {/*second div*/}
            <section className='flex justify-end relative'>
                     <div className='absolute top-[100px] right-[50%] '>
                       <img src="processline2.svg" alt="" />
                      </div>
                       <div className='bg-white py-[48px] px-8 flex gap-[52px] rounded-[20px] shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(0,69,165,0.2)] w-[50%]'>
                       <div className=''>
